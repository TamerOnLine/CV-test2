...
def render(profile: dict) -> dict:
    ...
    edited = st.data_editor(
        ...
        width="stretch",
        column_config={
            "Title": st.column_config.TextColumn(width="large", help="Project name"),
            "Description": st.column_config.TextColumn(width="large", help="One-line summary"),
            "URL": st.column_config.LinkColumn(help="Optional. We will auto-prefix https:// if missing."),
        },
    )
